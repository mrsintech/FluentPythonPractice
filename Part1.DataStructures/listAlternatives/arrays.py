...
obj_count = int(10**5)
print("testing speed difference between list and array", f"obj count {obj_count}")
...
print("Array Done.", "--------------------", "test ended.")

print("Build time compair:", f"list took:{li_time} seconds", f"array took: {ar_time} seconds")
print("get last item time compair:", f"list took:{li_get_time[0]} seconds", f"array took: {ar_get_time[0]} seconds")
